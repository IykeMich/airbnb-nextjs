...
const Button: React.FC<ButtonProps> = ({
    ...
    return ( 
        ...
        rounded-lg hover:opacity-80 transition w-full ${outline ? 'bg-white' : 'bg-rose-500'} 
        ${outline ? 'border-black text-black bg-white' : 'bg-rose-500 border-rose-500 text-white'}
